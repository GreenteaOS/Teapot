...
WriteSettings(POPTIONS_DLG infoPtr)
{
    ...
    {
        fwprintf(pFilecmd, L"::\n");
        fwprintf(pFilecmd, L":: This file has been automatically generated\n");
    ...
    {
        fwprintf(pFileps1, L"#\n");
        fwprintf(pFileps1, L"# This file has been automatically generated\n");
    ...
    if (pFile)
    {
        while (fgetws(WTempLine, 24+MAX_PATH, pFile))
        {
            ...
            else if (wcscmp(ptr, L"set") == 0)
            {
                ...
                else if ((!(0)) && (wcscmp(ptr, L"_ROSBE_HOST_MINGWPATH") == 0))
                {
