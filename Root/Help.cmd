...
if "%1" == "" (
    ...
    echo Make does a standard build of Greentea. OPTIONS are the standard ReactOS build
    echo options:
        echo.
    ...
    echo Usage: basedir
    echo Switches back to the GreenteaOS source directory.
) else if /i "%1" == "charch" (
    if exist "%_ROSBE_BASEDIR%\charch.cmd" (
    ...
    echo Fully clean the Greenteaos source directory.
    echo.
    ...
    if exist "%_ROSBE_BASEDIR%\sSVN.cmd" (
        ...
        echo Creates, updates or cleans up your Greenteaos source tree or shows the revision
